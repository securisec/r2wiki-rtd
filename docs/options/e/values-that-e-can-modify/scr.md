...
- `scr.color.pipe` Enable colors when using pipes _Default is false_
...
- `scr.dumpcols` Prefer pC commands before p ones
...
- `scr.wideoff` Adjust offsets to match asm.bits
